...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 inset-x-0 z-[1000] text-white transition-[transform,opacity,background-color,backdrop-filter,box-shadow] duration-300 ease-out ${
        hiddenOnScroll
          ? "-translate-y-full opacity-0"
          : "translate-y-0 opacity-100"
      } ${
        scrolled
          ? "bg-[#1e201d]/90 backdrop-blur-md shadow-[0_4px_20px_rgba(0,0,0,0.3)]"
          : "bg-[#1e201d]/60"
      }`}
      role="navigation"
      aria-label="Main"
