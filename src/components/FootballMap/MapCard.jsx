  ...
  return (
    <section className="w-full bg-transparent text-white">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="bg-[#1d1d1d] rounded-3xl p-6 sm:p-7 md:p-8 flex flex-col md:flex-row gap-6 md:gap-7 items-stretch justify-between shadow-[0_18px_50px_rgba(0,0,0,0.45)]">
          {/* Map Section */}
